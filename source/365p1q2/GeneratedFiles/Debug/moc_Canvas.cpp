...
QT_MOC_LITERAL(1, 7, 13), // "GetFilestream"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "std::string"
QT_MOC_LITERAL(4, 34, 1), // "f"
QT_MOC_LITERAL(5, 36, 1), // "l"
QT_MOC_LITERAL(6, 38, 1) // "d"

    },
    "Canvas\0GetFilestream\0\0std::string\0f\0"
    "l\0d"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GetFilestream((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    }
}
